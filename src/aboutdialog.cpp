...
void AboutDialog::setupTable() {
	...
	// RtMIDI
	addEntry(tr("RtMIDI"),
			 "All midi inout and output is realized with the RtMidi "
	...
	// USB Host
	addEntry(tr("USB Device Jack Icon"), "Downloaded from the <a "
										 "href='https://thenounproject.com/"
										 "'>NOUN Project</a><br/>"
										 "\nCreated by Okan Benn");
	// Ethernet Jack
	addEntry(tr("Ethernet Jack Icon"), "Downloaded from the <a "
									   "href='https://thenounproject.com/"
									   "'>NOUN Project</a><br/>"
	...
	addEntry(tr("RTP-Driver"),
			 "Ralf Beck created an RTP-Driver which I use "
